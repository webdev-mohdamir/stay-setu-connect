  ...
  const oneTimeServices = [
    {
      name: "Basic Setup",
      price: "₹3,999",
      description: "One-time setup on up to 3 OTAs",
      features: [
        "Listing on Goibibo, MMT, Booking.com",
    ...
    },
    {
      name: "Advanced Setup", 
      price: "₹6,999",
      description: "Complete setup on up to 5 OTAs",
      features: [
        "All Basic features",
        "Airbnb & Agoda inclusion",
        "SEO-optimized descriptions",
        "Promotional setup",
        "Photo shoot consultation"
      ]
    }
  ];
  ...
  return (
    <section id="pricing" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        {/* Monthly Plans */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-center text-gray-800 mb-8">Monthly Management Plans</h3>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              <Card key={index} className={`p-8 relative ${plan.popular ? 'ring-2 ring-orange-500 transform scale-105' : ''}`}>
                {plan.popular && (
                ...
                <Button 
                  ...
                  className={`w-full ${plan.popular ? 'bg-orange-500 hover:bg-orange-600' : 'bg-gray-800 hover:bg-gray-900'} text-white`}
                >
                  Get Started
                </Button>
              </Card>
        ...
        {/* One-time Services */}
        <div>
          <h3 className="text-2xl font-bold text-center text-gray-800 mb-8">One-Time Setup Services</h3>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 mb-4">Custom plans available for hotel chains</p>
          <Button 
            onClick={scrollToContact}
            variant="outline" 
